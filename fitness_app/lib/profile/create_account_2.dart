        ...
        child: Column(
          ...
          children: [
                  ...
                  child: Column(
                    children: [
                      ...
                      Widgets.field(
                        ...
                        hint: 'E.g John',
                        icon: const Icon(Icons.person, color:AppColors.primeOrange),
                      ),
                    ],
                  ),
                ),
            ...
            Widgets.field(
              ...
              hint: 'Select a date',
              icon: const Icon(Icons.calendar_today, color: AppColors.primeOrange),
            ),
            Spacer(flex: 1,),
            ...
            Widgets.field(
              ...
              icon: const Icon(Icons.location_on, color: AppColors.primeOrange),
            ),
            Spacer(flex: 1,),
            ...
            Widgets.field(
              ...
              icon: const Icon(Icons.location_city, color:AppColors.primeOrange),
            ),
            Spacer(flex: 8,),
            Widgets.button(
